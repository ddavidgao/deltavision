"""Compile DeltaVision action-normalization chapters from Angl."""
...
def main() -> int:
    ...
    repo_root = Path(__file__).resolve().parents[1]
    spec_path = repo_root / "specs" / "normalize_action_payload.angl"
    build_dir = repo_root / "angl_build" / "actions"
